    ...
    return (
      <main className="grid min-h-[65vh] place-items-center px-4 text-center">
        ...
        <div>
          ...
          <Link href="/#collection" className="primary-button mt-7">Browse collection</Link>
        </div>
      </main>
    );
  }
    ...
    <main className="py-6 sm:py-10">
      ...
      <div className="section-shell">
        <nav className="mb-5 flex flex-wrap items-center gap-2 text-xs text-white/35" aria-label="Breadcrumb">
          <Link href="/" className="hover:text-[#dfc184]">Home</Link>
          <span>/</span>
          <Link href="/#collection" className="hover:text-[#dfc184]">Collection</Link>
          <span>/</span>
