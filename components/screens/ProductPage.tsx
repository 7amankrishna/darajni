...
function ProductFacts({ product }: { product: Product }) {
  ...
  return (
    <section className="rounded-2xl border border-[#E8E2DA] dark:border-[#3B3026] bg-white dark:bg-[#1B1612] p-5">
      <h2 className="font-display text-3xl leading-none text-[#1E1E1E] dark:text-[#F7EADB]">
        Product Details
      </h2>
      <dl className="mt-5 grid gap-3">
        {facts.map(([label, value]) => (
          <div key={label} className="grid gap-1 border-b border-[#E8E2DA] dark:border-[#3B3026] pb-3 last:border-b-0 last:pb-0 sm:grid-cols-[9rem_1fr]">
            <dt className="text-xs font-extrabold uppercase text-[#C8A97E]">
              {label}
            </dt>
            <dd className="text-sm leading-6 text-[#666666] dark:text-[#B8A898]">{value}</dd>
          </div>
        ))}
      </dl>
    </section>
    ...
    <aside className="space-y-4 xl:sticky xl:top-32">
      <section className="rounded-2xl border border-[#E8E2DA] dark:border-[#3B3026] bg-white dark:bg-[#1B1612] p-5">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-display text-2xl text-[#1E1E1E] dark:text-[#F7EADB]">Size Guide</h2>
        </div>
        <div className="table-scroll mt-4">
          <table className="w-full min-w-[260px] text-left text-[0.68rem] text-[#666666] dark:text-[#B8A898]">
            <thead className="bg-[#F9F9F9] dark:bg-[#241D17]">
              <tr>
      ...
      <section className="rounded-2xl border border-[#E8E2DA] dark:border-[#3B3026] bg-white dark:bg-[#1B1612] p-5">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-display text-2xl text-[#1E1E1E] dark:text-[#F7EADB]">Delivery</h2>
        </div>
      ...
      <section className="rounded-2xl border border-[#E8E2DA] dark:border-[#3B3026] bg-white dark:bg-[#1B1612] p-5">
        <div className="flex items-center gap-2">
          <HeartHandshake className="h-5 w-5 text-[#C8A97E]" />
          <h2 className="font-display text-2xl text-[#1E1E1E] dark:text-[#F7EADB]">Exchange</h2>
        </div>
        <ul className="mt-4 grid gap-2 text-sm leading-6 text-[#666666] dark:text-[#B8A898]">
      ...
      <section className="rounded-2xl border border-[#E8E2DA] dark:border-[#3B3026] bg-[#171717] p-5 text-white">
        <div className="flex items-center gap-2">
...
export default function ProductPage({
  ...
  return (
    <main className="bg-white dark:bg-[#100D0B] py-6 sm:py-10">
      <div className="section-shell">
        <nav
          className="mb-5 flex flex-wrap items-center gap-2 text-xs font-semibold text-[#666666] dark:text-[#B8A898]"
        ...
        >
          ...
          <span>/</span>
          <span className="text-[#1E1E1E] dark:text-[#F7EADB]">{product.name}</span>
        </nav>
          ...
          <div className="min-w-0">
            <div>
              <div className="flex flex-wrap gap-2">
                ...
                {product.isFeatured && (
                  <span className="status-pill bg-[#F9F9F9] dark:bg-[#241D17] text-[#6E0F1A]">
              ...
              <h1 className="font-display mt-3 text-5xl leading-[0.92] text-[#1E1E1E] dark:text-[#F7EADB] sm:text-6xl">
                {product.name}
              </h1>
              <div className="mt-5 flex flex-wrap items-end gap-3">
                <p className="font-display text-4xl font-semibold text-[#1E1E1E] dark:text-[#F7EADB]">
                  {formatPrice(price)}
                </p>
                <p className="pb-1 text-xs font-semibold uppercase text-[#666666] dark:text-[#B8A898]">
                  {priceNote}
                </p>
                {product.discount > 0 && (
                  <span className="mb-1 rounded-full bg-[#F9F9F9] dark:bg-[#241D17] px-3 py-1 text-[0.62rem] font-extrabold uppercase text-[#6E0F1A]">
        ...
        {related.length > 0 && (
          <section data-reveal className="py-20">
            ...
            <h2 className="font-display mt-3 text-5xl leading-none text-[#1E1E1E] dark:text-[#F7EADB]">
              Similar designs
            </h2>
